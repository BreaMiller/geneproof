...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for herb-images" ON storage.objects FOR SELECT USING (bucket_id = 'herb-images');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for herb-images" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'herb-images');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for herb-images" ON storage.objects FOR UPDATE USING (bucket_id = 'herb-images');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for herb-images" ON storage.objects FOR DELETE USING (bucket_id = 'herb-images');`
    ];
