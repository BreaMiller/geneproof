...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for recipe-images" ON storage.objects FOR SELECT USING (bucket_id = 'recipe-images');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for recipe-images" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'recipe-images');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for recipe-images" ON storage.objects FOR UPDATE USING (bucket_id = 'recipe-images');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for recipe-images" ON storage.objects FOR DELETE USING (bucket_id = 'recipe-images');`
    ];
