...
export default function FoodProtocolPage() {
      ...
      <div className="px-6 py-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-center flex-1">
            <h1 className="text-2xl font-bold text-white">Food Protocol</h1>
        ...
        {featured && (
          <div className="bg-slate-900/60 backdrop-blur-xl rounded-2xl p-6 shadow-xl border border-purple-500/20 mb-6">
            ...
            <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-gradient-to-br from-purple-600 to-pink-600 overflow-hidden">
              {featured.image_url ? (
            ...
            {featured.health_benefits && Array.isArray(featured.health_benefits) && (
              <div className="space-y-2 mb-3">
                {featured.health_benefits.slice(0, 2).map((benefit, i) => (
        ...
        {Object.entries(groupedRecipes).map(([mealType, mealRecipes]) => (
          <div key={mealType} className="mb-6">
            <h3 className="text-white font-bold text-lg mb-4 capitalize">{mealType}</h3>
            <div className="grid grid-cols-2 gap-4">
              {mealRecipes.map((recipe) => (
                ...
                >
                  ...
                  <div className="w-20 h-20 mx-auto mb-3 rounded-full bg-gradient-to-br from-purple-600 to-pink-600 overflow-hidden">
                    {recipe.image_url ? (
                  ...
                  <h4 className="text-white font-semibold text-sm text-center mb-2">{recipe.name}</h4>
                  {recipe.health_benefits && Array.isArray(recipe.health_benefits) && recipe.health_benefits[0] && (
                    <div className="flex items-center gap-1 justify-center mb-2">
                      <div className="w-4 h-4 rounded-full bg-blue-600 flex items-center justify-center text-white text-xs">✓</div>
                      <span className="text-xs text-blue-400">{recipe.health_benefits[0]}</span>
                    </div>
                  )}
